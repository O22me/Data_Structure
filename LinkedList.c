...
int main(void) {
	...
	InitManager(manager_stack);	//stack type list 초기화.
	InitManager(manager_queue);	//queue type list 초기화.
	InitManager(manager_list);		//double linked list 초기화.

	PrintList(manager_list);

	InsertNodeEnd(manager_list, 10); //-10-
	InsertNodeEnd(manager_list, 20); //-10-20-
	InsertNodeEnd(manager_list, 30); //-10-20-30-

	PrintList(manager_list);

	DeleteNodeData(manager_list, 20); //-10-30-
